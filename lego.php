...
$products = get_products_by_category_slug($pdo, 'lego');
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="category-bar">
  ...
  <a href="lego.php" class="cat-item active">
...
<div class="container">
  <div class="page-hero">
    ...
    <p>Discover creative builds from city sets and speed champions to collector-level display kits.</p>
  </div>

  <div class="section-title">All LEGO Products</div>
  <div class="product-grid">
    <?php foreach ($products as $product): ?>
      <div class="product-card">
        <img src="<?= h($product['image'] ?: 'images/lego.webp') ?>" alt="<?= h($product['name']) ?>">
        <div class="product-meta">
          ...
          <form method="post" action="add_to_cart.php" class="action-row">
            ...
            <input type="hidden" name="redirect" value="lego.php">
